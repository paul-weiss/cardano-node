...
module Cardano.Testnet.Test.Gov.InitiateHardfork
  ( hprop_initiate_hardfork
  ) where
...
hprop_initiate_hardfork = H.integrationWorkspace "propose-new-constitution" $ \tempAbsBasePath' -> runWithDefaultWatchdog_ $ do
